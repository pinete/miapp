...
<div id="modal-adjuntar" class="fixed inset-0 z-10 hidden flex items-center justify-center">
    ...
    <div id="modal-crear-content" class="modal-content relative bg-white rounded-lg shadow-lg w-full max-w-md p-6 mx-auto z-50 transition transform scale-95 opacity-0">
        ...
        <form
            ...
            @csrf
            <!-- Usamos PUT para actualizar el recurso al que se le adjunta el archivo -->
            <!-- El controlador decidirá a qué entidad y registro se le adjunta el archivo -->
            <!-- Los campos entidad e id se rellenan mediante script al abrir el modal -->
            <input type="hidden" name="entidad" id="adjuntoEntidad">
            <input type="hidden" name="id" id="adjuntoId">
            <div class="modal-content">
                <div class="modal-header"><h3>Adjuntar archivo</h3></div>
                <div class="modal-body">
                    <label for="archivo" class="block font-medium mb-1">Documento</label>
                    <input type="file"
                        id="docAdjunto"
                        name="archivo"
                        class="form-control w-full mb-3 p-2 border rounded">
